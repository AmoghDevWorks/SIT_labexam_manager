        ...
        <div className="bg-white/85 backdrop-blur-md border border-[#00c9a7]/25 rounded-2xl shadow-[0_8px_32px_rgba(15,31,61,0.12)] overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-6">
              <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-[#00c9a7] to-[#00a98c] flex items-center justify-center shadow-[0_8px_24px_rgba(0,201,167,0.3)]">
